...
public interface AuditLogDAO {
    ...
    /** Same as {@link #save(AuditLog)} but composable into a caller-managed transaction
     *  (e.g. logging a LOGIN action atomically alongside session creation). */
    AuditLog save(AuditLog log, Connection conn) throws Exception;
